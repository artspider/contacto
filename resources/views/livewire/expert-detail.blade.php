            ...
            <div class="card__card--body flex flex-wrap justify-between items-start">
                ...
                <div class="card__card--body__col1 bg-white mt-14 mr-2">
                    ...
                    <div class="contacto rounded-md shadow-lg p-6">
                        <div
                            class="contacto__top flex items-center text-gray-700 "
                        >
                            <svg
                        ...
                        <div class="contacto__body mt-6">
                            <div
                                class="contacto__body__email flex items-center"
                            >
                                <svg
                            ...
                            <div
                                class="contacto__body__telefono flex items-center mt-4"
                            >
                                <svg
                                    class="fill-content text-gray-600 h-5 w-5 mr-2"
                                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="skils rounded-md shadow-lg p-6">
                        <div
                            class="skills__top flex items-center text-gray-700 "
                        >
                            <svg
                                class=" fill-current h-8 w-8 mr-4"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                            >
                                <path
                        ...
                        <div class="skills__body mt-6">
                            <ul
                                class=" list-disc list-inside text-gray-700 tracking-wider leading-loose "
                            >
                                @empty($habilidades)
                ...
                <div class="card__card--body__col2 bg-white mt-14 ml-2">
                    ...
                    <div class="about rounded-md shadow-lg p-6">
                        <div
                            class="about__top flex items-center text-gray-700 "
                        >
                            <svg
                                class=" fill-current h-10 w-10 mr-4"
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="experiencia rounded-md shadow-lg p-6">
                        <div
                            class="experiencia__top flex items-center text-gray-700 "
                        >
                            <svg
                                class=" fill-current h-10 w-10 mr-4"
                                xmlns="http://www.w3.org/2000/svg"
                            ...
                            >
                                <path
                                    d="M9.484 15.696L8.773 15l-2.552 2.607-1.539-1.452-.698.709L6.234 19l3.25-3.304zm0-5L8.773 10l-2.552 2.607-1.539-1.452-.698.709L6.234 14l3.25-3.304zm0-5L8.773 5 6.221 7.607 4.682 6.155l-.698.709L6.234 9l3.25-3.304zM20 17h-8v1h8v-1zm0-5h-8v1h8v-1zm0-5h-8v1h8V7zm4-5H0v20h24V2zm-1 19H1V3h22v18z"
                                />
                            </svg>
                            <p class="text-2xl font-semibold tracking-wider">
                                Experiencia
                    ...
                    <div class="redes rounded-md shadow-lg p-6">
                        <div
                            class="redes__top flex items-center text-gray-700 "
                        >
                            <svg
                                class=" fill-current h-10 w-10 mr-4"
                                xmlns="http://www.w3.org/2000/svg"
